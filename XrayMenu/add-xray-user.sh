...
vless_link="vless://${uuid}@${public_host}:443?encryption=none&type=ws&security=tls&host=${public_host}&path=%2Fvless&sni=${public_host}#VLESS-${user}"
...
vless_hu_link="vless://${uuid}@${public_host}:443?encryption=none&type=httpupgrade&security=tls&host=${public_host}&path=%2Fvless-hu&sni=${public_host}#VLESS-HU-${user}"
...
trojan_link="trojan://${uuid}@${public_host}:443?type=ws&security=tls&sni=${public_host}&host=${public_host}&path=%2Ftrojan-ws&allowInsecure=0#TROJAN-${user}"
trojan_ntls_link="trojan://${uuid}@${public_host}:80?type=ws&security=none&host=${public_host}&path=%2Ftrojan-ws#TROJAN-NTLS-${user}"
trojan_hu_link="trojan://${uuid}@${public_host}:443?type=httpupgrade&security=tls&sni=${public_host}&host=${public_host}&path=%2Ftrojan-hu&allowInsecure=0#TROJAN-HU-${user}"
